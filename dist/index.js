...
var NationalCodeFunction = function (nationalCode) {
  ...
  this.getMapData = function () {
    return reduceData('phone_code', this.data);
  };
  // map数据 补全三位code为key
  this.getMapDataByCompleteCode = function () {
    return reduceData('complete_phone_code', this.data);
  };

  this.getMapDataByNameCode = function () {
    return reduceData('name_code', this.data);
  };
  // 根据code 获取item
  ...
  this.getCompleteCodeList = function () {
    return this.data.map(function (item) {
      return item.complete_phone_code;
    });
  };
};
